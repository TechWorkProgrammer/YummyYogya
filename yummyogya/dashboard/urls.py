...
from .views import (
    dashboard, add_food, edit_food, delete_food, get_foods, user_dashboard,
    add_food_flutter, get_food_list, delete_food_flutter, dashboard_data,
    get_user_id, update_food_flutter
)
...
urlpatterns = [
    ...
    path('api/user_dashboard/', user_dashboard, name='user_dashboard'),
